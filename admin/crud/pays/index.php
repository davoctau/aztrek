...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <img src="<?php echo SITE_URL . "/uploads/" . $pays["carte"]; ?>" class="img-thumbnail">
            </td>
            <td>
                <img src="<?php echo SITE_URL . "/uploads/" . $pays["image_slider"]; ?>" class="img-thumbnail">
            </td>
            <td><?php echo $pays["titre_slider"]; ?></td>
